reg.conf.intervals <- function(x, y) {
  ...
  b2 <- lm.model$coefficients[3]
  b3 <- lm.model$coefficients[4]
  b4 <- lm.model$coefficients[5]
  b5 <- lm.model$coefficients[6]
  b6 <- lm.model$coefficients[7]
  b7 <- lm.model$coefficients[8]
